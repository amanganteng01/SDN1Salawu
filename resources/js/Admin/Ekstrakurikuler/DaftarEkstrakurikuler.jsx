...
export default function DaftarEkstrakurikuler({ ekstrakurikuler }) {
    ...
    return (
        <div className="p-6">
                    ...
                    <table className="w-full">
                        <thead className="bg-slate-100 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-left text-sm font-semibold text-slate-700">Nama Ekstrakurikuler</th>
                                <th className="px-6 py-4 text-left text-sm font-semibold text-slate-700">Pembina</th>
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {ekstrakurikuler.length > 0 ? (
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-500">{item.jadwal_latihan}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-sm text-slate-600">{item.pembina}</td>
                                        <td className="px-6 py-4">
                                ...
                                /* State kosong - Tidak ada data ekstrakurikuler */
                                <tr>
                                    <td colSpan="4" className="px-6 py-8 text-center">
                                        <div className="text-slate-500">
                                            <Users className="w-12 h-12 mx-auto mb-2 text-slate-300" />
                                            <p className="text-sm">Tidak ada data ekstrakurikuler</p>
                                            <p className="text-xs mt-1">Klik "Tambah Ekstrakurikuler" untuk menambahkan data pertama</p>
                                        </div>
                                    </td>
                                </tr>
                            )}
            ...
            <Modal isOpen={openTambah} onClose={() => setOpenTambah(false)} title="Tambah Ekstrakurikuler">
            ...
            <Modal isOpen={openEdit} onClose={() => setOpenEdit(false)} title="Edit Ekstrakurikuler">
                <EditEkstrakurikuler ekstrakurikuler={selectedEkstra} onClose={() => setOpenEdit(false)} />
            </Modal>
        </div>
    );
}
