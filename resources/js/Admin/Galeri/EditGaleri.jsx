...
export default function EditGaleri({ galeri, onClose }) {
    ...
    useEffect(() => {
        if (galeri) {
            setData({
                ...
                file: null, // File dikosongkan agar tidak overwrite file lama
    ...
    return (
        <form onSubmit={submit} className="space-y-5">
            ...
            <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">
                    File {data.kategori === "foto" ? "Foto" : "Video"} (Opsional)
                </label>
                    ...
                    <label className="flex-1 cursor-pointer">
                        ...
                        <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-500 transition-colors">
                            ...
                            <p className="text-sm text-slate-600">
                                {data.file ? data.file.name : "Klik untuk upload file baru"}
                            </p>
            ...
            <div className="flex items-center justify-end gap-3 pt-4">
                ...
                >
                    {processing ? "Memperbarui..." : "Perbarui Galeri"}
                </button>
            </div>
        </form>
    );
