...
export default function Layout({children}){
    ...
    return (
        <>
            ...
            <main className="
                flex flex-col
                px-3 py-1 gap-1 mt-10
                sm:px-4 sm:py-2 sm:gap-2 sm:mt-10.5
                md:px-5 md:py-3 md:gap-3 md:mt-14
                lg:px-6 lg:py-4 lg:gap-4 lg:mt-17
                xl:px-7 xl:py-5 xl:gap-5 xl:mt-20.5
                2xl:px-8 2xl:py-6 2xl:gap-6 2xl:mt-23.5
